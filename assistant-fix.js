(() => {
  ...
  const answer = (raw) => {
    ...
    if (/what (do|can) you have for me|what have you for me|what can you offer|what do you offer|tell me about shakti|about shakti|what is shakti millets|who is shakti millets/.test(m))
      return '🌾 Welcome to Shakti Millets!\n\nShakti Millets brings you quality millets and traditional grains for everyday meals as well as business requirements. Our catalogue includes Pearl Millet (Kambu), Kodo Millet, Barnyard Millet, Little Millet, Foxtail Millet, Browntop Millet, Proso Millet, Ragi, Sorghum, Horsegram and traditional red-rice varieties.\n\nWe offer retail packs, a 5 Little Millets Combo, and B2B/bulk supply support for restaurants, hotels, cafés, cloud kitchens, retailers, supermarkets, food manufacturers and distributors.\n\nI can help you choose products, explain uses and nutrition, suggest recipes, share published MRP, compare products and guide you with bulk enquiries. What would you like to explore?';
    if (/^(hi|hello|hey|namaste|good morning|good afternoon|good evening)\b/.test(m))
      return 'Hello! 👋 Welcome to Shakti Millets. I can tell you about our products, millet nutrition, cooking ideas, recipes, prices and B2B supply. What would you like to know?';
    if (/who are you|what are you|your name/.test(m))
      return 'I am Shakti AI, the website assistant for Shakti Millets. I help customers understand our millets and traditional grains, choose products, learn cooking and nutrition information, and enquire about retail or B2B supply.';
    if (/song|music|movie|film|actor|actress|lyrics|playlist/.test(m))
      return 'I am the Shakti Millets website assistant, so I focus on Shakti Millets, food, millets, nutrition, recipes, products and business enquiries.';
    if (/\b(price|mrp|cost|rate)\b/.test(m))
      return 'You can see the published MRP and pack size on each Shakti Millets product card. For current bulk pricing, use the B2B enquiry form or WhatsApp Shakti Millets.';
    if (/\b(product|products|catalog|catalogue)\b/.test(m))
      return 'Shakti Millets currently has 20 individual millet/traditional-grain and rice products plus the 5 Little Millets Combo. Tell me a product name and I can explain it.';
    ...
    if (/\b(recipe|recipes|cook|cooking|prepare|preparation|breakfast|lunch|dinner)\b/.test(m))
      return 'You can make millet porridge, dosa, idli, upma, khichdi, roti and rice-style meals. Tell me which Shakti Millets product you have and I can suggest a simple recipe.';
  ...
  // Capture Enter before the old script.js keydown listener can call Wikipedia.
